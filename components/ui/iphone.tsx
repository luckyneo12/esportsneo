...
export function Iphone({
  ...
  return (
    ...
    >
      {hasVideo && (
        <div
          className="pointer-events-none absolute  flex justify-center items-center z-0 overflow-hidden"
          style={{
            left: `${LEFT_PCT}%`,
            top: `${TOP_PCT}%`,
            width: `${WIDTH_PCT}%`,
        ...
        >
          <video
            className="block oc scale-[1.3]  w-full object-cover object-center -rotate-90 "
            src={videoSrc}
            autoPlay
            loop
            muted
